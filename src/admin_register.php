...
if(isset($_POST['Send'])){
  ...
  $cPassword = mysqli_real_escape_string($connect, $_POST['cPassword']);
    ...
    if (empty($Nom)) {
        ...
        $sqlInsert = "INSERT INTO utilisateurs(utilisateur, tel, email, psswrd, autorisation) VALUES ('$Nom','$Tel','$Email','$password','admin')";
        $sqladapter = mysqli_query($connect, $sqlInsert);


        if($sqladapter){
            
            echo '<script>alert("L\'inscription d\'admin a réussi, Connectez-vous!!")</script>';
    ...
    <div class="relative p-4 w-full max-w-md md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="p-5">
                ...
                <form method="post" action="admin_register.php" class="w-full">
                    ...
                    <input name="nomPrenom" type="text" required
                        ...
                        <label for="email" class="sr-only">Adress E-mail</label>
                    ...
                    <br>
                    <button type="submit" name="Send" class="inline-flex w-full items-center justify-center rounded-lg bg-red-500 p-2 py-3 text-sm font-medium text-white outline-none focus:ring-2 focus:ring-black focus:ring-offset-1 disabled:bg-gray-400">
                        Sign in     
                    </button>
                </form>
