...
if (isset($_POST["Envoyer"])) {
    ...
    if (isset($_SESSION["shopping_cart"])) {
        ...
        if (!in_array($_GET["Id"], $item_array_id)) {
            ...
            echo '<script>window.location="boissans.php"</script>';
        } else {
...
?>
  ...
  <div
    ...
    ><span class="text-white font-bold"><?php echo $row['Prix']?> MAD</span></div>


			
			<form method="POST" action="boissans.php?Id=<?php echo $row['Id']?>">


				<img class="px-6 pt-6 pb-3 rounded-t-lg" src="./boissans/<?php echo $row['Image']?>" alt="product image" />
...
<h1 align="center" class="mb-5 font-semibold text-xl md:text-2xl italic" id="cartDetails"><span class="text-red-500">Votre</span> Commande</h1>
						...
						foreach($_SESSION["shopping_cart"] as $keys => $values)
{
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4">
                    <a href="boissans.php?action=delete&Id=<?php echo $values["ID"]; ?>" class="font-bold text-white rounded-full bg-red-500 border border-red-100 p-2 hover:underline">Remove</a>                </td>
            </tr>
                ...
                <?php $total = $total + ($values["Quantité"] * $values["Prix"]); } ?>
					...
					<tr align="center" class="bg-red-300 border-b text-xl dark:bg-gray-800 dark:border-gray-700">
						...
						<td class="th"><a href="boissans.php?action=clearall"><button class="btn btn-red-500 text-white rounded-lg">clear all</button></a></td>
					</tr>
